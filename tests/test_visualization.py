...
def test_base_visualizer_initialization(tmp_output_dir):
    """测试基础可视化器初始化"""
    base_visualizer = BaseVisualizer(tmp_output_dir)
    assert base_visualizer is not None
    assert base_visualizer.output_dir == tmp_output_dir


def test_feature_space_visualizer_initialization(tmp_output_dir):
    """测试特征空间可视化器初始化"""
    feature_visualizer = FeatureSpaceVisualizer(tmp_output_dir)
    assert feature_visualizer is not None


def test_behavior_visualizer_initialization(tmp_output_dir):
    """测试行为可视化器初始化"""
    behavior_visualizer = BehaviorVisualizer(tmp_output_dir)
    assert behavior_visualizer is not None


def test_report_generator_initialization(tmp_output_dir):
    """测试报告生成器初始化"""
    base_visualizer = BaseVisualizer(tmp_output_dir)
